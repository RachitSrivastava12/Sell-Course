...
var Portal = React30.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(React30.isValidElement(children2) ? children2.ref : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    if (React30.isValidElement(children2)) {
      ...
      return React30.cloneElement(children2, newProps);
    }
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-ZY5YOGPK.js.map
